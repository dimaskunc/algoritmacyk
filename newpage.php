        ...
        <div class="container">
            <div class="row no-gutters">
                    ...
                    <div id="mycarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner carousel">
                            <div class="carousel-item active" data-interval="4500">
                                <img src="img/bg 1.jpg" class="img-fluid img" style="height: 410px;" alt="bg 1">
                            </div>
                            <div class="carousel-item" data-interval="4500">
                                <img src="img/bg 2.jpg" class="img-fluid img" style="height: 410px;" alt="bg 2">
                            </div>
                            <div class="carousel-item" data-interval="4500">
                                <img src="img/bg 3.jpg" class="img-fluid img" style="height: 410px;" alt="bg 3">
                            </div>
                        </div>
                ...
                <div class="col-lg-7 px-5 pt-5">
                    <h1 class="font-weight-bold py-3">Program CYK Bahasa Jawa</h1>
                    <h4>Masukkan Kalimat Bahasa Jawa</h4>
                    <form action="" method="post">
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="text" name="input" placeholder="Kalimat Bahasa Jawa" class="form-control my-3 p-4">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                                <button type="submit" name="submit" class="btn1 mt-2 mb-5">Uji</button>                                
                            </div>
                        </div>
                    </form>
                    <p id="result"></p>
